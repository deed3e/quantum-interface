...
import detectEthereumProvider from './OkexEthereumProvider'
...
export class Okex extends Connector {
    ...
    private async isomorphicInitialize(): Promise<void> {
        ...
        return (this.eagerConnection = import('./OkexEthereumProvider').then(
            async (m) => {
