    ...
    const onConfirms = useCallback(async () => {
        try {
            if (inputAmount && outputAmount && tokenIn && tokenOut) {
                ...
                const data = await routerContract?.callStatic[method](...args, {
                    value,
                })
                if (data?.pair) {
                    initDataTransaction.setAddErc20({
        ...
        <>
            ...
            <SwapContainer ref={ref}>
                ...
                <Tip>
                    ...
                    representing your position. These tokens automatically earn
                    fees proportional to your share of the pool, and can be
